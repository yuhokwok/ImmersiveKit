...
class ClientViewController: UIViewController, GCDAsyncSocketDelegate, NetServiceDelegate, NetServiceBrowserDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
